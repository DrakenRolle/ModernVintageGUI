...
* No runtime loader. The designer reads and writes its XML markup and hands back C#, but the mod
  cannot load such a file at runtime yet - the C# is how a design gets into a mod today
